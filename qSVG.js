document.querySelector('#lin').addEventListener('touchstart', e => console.log('TOUCH START', e.touches.length), {passive:false});
document.querySelector('#lin').addEventListener('pointerdown', e => console.log('POINTER DOWN', e.pointerType, e.clientX, e.clientY), {passive:false});
