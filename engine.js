...
// ========================================
// TOUCH & MOUSE ZOOM/PAN INITIALIZATION
// ========================================
$(document).ready(function() {
    
    var svgElement = $('#lin');
    
    // Apply unified scrolling for zoom (works on both desktop and mobile)
    svgElement.unifiedScroll(function(event, delta, deltaX, deltaY) {
        ...
        // Example: trigger existing zoom functions
    ...
    console.log('Touch and Mouse zoom enabled on SVG');
});
